...
public class IFLYTEKSpeechProcessing implements ISpeechProcessing {
    @Override
    public void speechSynthesisByString(String sentence) {
        start(sentence);
    }

    private static final String TAG = "IFLYTEKSpeechProcessing";
    ...
    public IFLYTEKSpeechProcessing(Context context) {
        mContext = context;
        // 初始化合成对象
